...
import {BurgerMenuPropsType} from "./BurgerMenu";
import {mainTheme} from "../../layout/styles/Theme";

export const StyledBurgerMenu = styled.nav<BurgerMenuPropsType>`
  order: 0;
...
export const Bar = styled.span<{ theme: any, isMenuOpen: any, queue: string }>`
  display: block;
  width: 40px;
  height: 5px;
  margin-bottom: 7px;
...
export const Mask = styled.span<{ theme: any }>`
  position: absolute;
  top: 0;
  left: 0;
